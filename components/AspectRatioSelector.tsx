  ...
  return (
    <div>
      <div className="flex items-center mb-3">
        <div className="flex items-center justify-center w-6 h-6 ml-3 text-black bg-green-400 rounded-full text-sm font-bold">4</div>
        <label className="block text-md font-medium text-green-300 font-tech-mono">اختر أبعاد الصورة</label>
      </div>
