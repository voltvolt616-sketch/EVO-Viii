  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center z-50 p-4 animate-fade-in">
      <div className="bg-gray-900 border border-green-700 rounded-xl shadow-2xl w-full max-w-lg relative p-8">
        <button onClick={onClose} className="absolute top-4 left-4 text-gray-500 hover:text-green-400 transition-colors">
          <CloseIcon className="h-6 w-6" />
        </button>
        
        <h2 className="text-2xl font-bold text-green-300 mb-4 font-mono">تعديلات إضافية</h2>
        <p className="text-gray-400 mb-6">صف التغييرات التي تريدها. على سبيل المثال: "اجعل الإضاءة أكثر نعومة" أو "أضف انعكاسًا على الأرض".</p>

        {isEditing ? (
            <div className="py-12">
                <Spinner message="جاري تطبيق التعديلات..." />
            </div>
        ) : (
            <form onSubmit={handleSubmit}>
              <textarea
                ...
                placeholder="مثال: تغيير حجم الشعار، إضافة نص 'تخفيضات الصيف'..."
