  ...
  return (
    <div className="w-full">
      <div className="flex items-center mb-2">
        <div className="flex items-center justify-center w-6 h-6 ml-3 text-black bg-green-400 rounded-full text-sm font-bold">{step}</div>
        ...
        {preview ? (
          <>
            ...
            <button 
              ...
              className="absolute top-2 left-2 p-1 bg-black/50 text-white rounded-full hover:bg-black/80 transition-all"
          ...
          <div className="text-center text-gray-400 group-hover:text-green-300">
            ...
            <p className="mt-1 text-xs">انقر للرفع</p>
          </div>
        )}
      </div>
    </div>
