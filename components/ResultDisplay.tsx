  ...
  if (!image) {
    return (
        <div className="w-full h-full min-h-[30rem] flex flex-col items-center justify-center text-center glass-pane rounded-xl p-8">
            ...
            <h3 className="mt-6 text-xl font-orbitron text-green-300/80">سيظهر إبداعك هنا</h3>
            <p className="mt-2 text-gray-400">ارفع صورك وانقر على 'إنشاء'.</p>
        </div>
    );
  }
  ...
  return (
    <div className="w-full flex flex-col items-center animate-fade-in">
      ...
      <div className="flex space-x-4 mt-8">
        ...
        >
          <EditIcon className="h-5 w-5 ml-2" />
          إجراء تعديلات
        </button>
      </div>
    </div>
